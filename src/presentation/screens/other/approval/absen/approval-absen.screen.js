...
import ApprovalAbsenHistory from './approval-absen-history.screen';
import ApprovalAbsenNew from './approval-absen-new.screen';
    ...
    <Layout>
      ...
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          component={ApprovalAbsenNew}
        />
        <Tab.Screen
          name="leaveList"
          options={{tabBarLabel: 'Riwayat'}}
          component={ApprovalAbsenHistory}
        />
      </Tab.Navigator>
